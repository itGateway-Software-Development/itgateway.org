  ...
  <div class="carousel-wrapper">
    ...
    <div class="carousel-content" v-if="currentImageIndex == 0">
      <h2 class="mb-5" data-aos="fade-down">
        itGateway is the Fastest Growing Company in South East Asia
      </h2>
      <p class="mb-1 text-white">
        Up to <span class="special-text">8 Services Category Groups</span>
      </p>
      <p class="text-white">
        Focus on Innovation Led by Young Research Engineers
      </p>
      <button class="btn primary-btn d-flex gap-2 align-items-center">
        Find Out More <span class="material-symbols-outlined">east</span>
      </button>
    </div>
    <div class="carousel-content" v-if="currentImageIndex == 1">
      <h2 class="mb-5" data-aos="flip-up">
        itGateway Cloud Infrastructure is to launch in 2024
      </h2>
      <p class="mb-1 text-white">
        We are planning to offer the cloud services across the world
      </p>
      <p class="text-white">
    ...
    <div class="carousel-content" v-if="currentImageIndex == 2">
      <h2 class="mb-5" data-aos="flip-down">
        Research is The Key to build the Innovation & Development.
      </h2>
      <p class="mb-1 text-white">
        We are trying a first innovation center of our group.
      </p>
      <p class="text-white">
